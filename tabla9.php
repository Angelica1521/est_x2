			...
			<table border="3">
				<thead>
					<tr><br><br><br>
						...
						<th colspan="10">&nbsp;&nbsp;USUARIO MODIFICADO !!!</th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td><?php echo $row['contra']; ?></td>		
						 ...
						 <td><a href="modifica3.php?id=<?php echo $row['id_user']; ?>">Modificar</a></td>
						 <td><a href="elimina3.php?id=<?php echo $row['id_user']; ?>">Eliminar</a></td>
